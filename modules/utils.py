...
AVATARS = ['baby_daisy', 'baby_luigi', 'baby_mario', 'baby_peach', 'baby_rosalina', 'bowser', 'daisy', 'donkey',
           'dry_bones', 'koopa', 'lakitu', 'larry', 'lemmy', 'link', 'ludwig', 'luigi', 'mario', 'mario2', 'metal_mario', 'morton',
           'peach', 'rosalina', 'shy_guy', 'toad', 'toadette', 'roy', 'waluigi', 'wario', 'wendy', 'yoshi']
